        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input type="text" required placeholder="Enter your name..." value={form.name}
                      ...
                      className="w-full px-4 py-3 border border-gray-700 rounded-xl text-sm text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900"/>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 mb-1.5">AI Message</label>
                    <textarea required rows={4} placeholder="Type..." value={form.message}
                      onChange={e => setForm({ ...form, message: e.target.value })}
                      className="w-full px-4 py-3 border border-gray-700 rounded-xl text-sm text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"/>
                  </div>
            ...
            <div className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden">
              <div className="p-6">
                <h2 className="text-base font-bold text-white mb-5">Contact Information</h2>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-indigo-200 h-52 relative">
                ...
                <div className="absolute bottom-3 left-3 bg-white rounded-lg px-3 py-1.5 shadow text-xs font-semibold text-gray-200">
                  📍 SmartChain Hub HQ
                </div>
              </div>
            </div>
