...
export default function Profile() {
  ...
  if (authLoading || loading) return <div className="flex items-center justify-center h-64 text-gray-500">Loading...</div>;
    ...
    <>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          <h3 className="text-base font-bold text-white mb-6">Personal Information</h3>
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <div>
              ...
              <input type="email" value={user?.email || ''} readOnly
                className="w-full px-4 py-3 border border-gray-700 rounded-xl text-sm text-gray-500 bg-gray-900 cursor-not-allowed"/>
            </div>
            <div>
        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-800">
              ...
              <button className="px-4 py-1.5 border border-gray-700 text-sm text-gray-500 rounded-lg hover:bg-gray-800">Update Password</button>
            </div>
            <div className="flex items-center justify-between py-3 border-b border-gray-800">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full border-2 border-gray-300 flex items-center justify-center text-gray-500">
